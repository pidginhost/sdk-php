...
/**
 * FirewallRulesSet Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class FirewallRulesSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirewallRulesSet';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FirewallRulesSet., must be smaller than or equal to 200.');
        }
     ...
     * Gets status
     *
     * @return \PidginHost\\Sdk\Model\FirewallRulesSetStatusEnum
     */
     ...
     * Sets status
     *
     * @param \PidginHost\\Sdk\Model\FirewallRulesSetStatusEnum $status status
     *
     * @return self
     */
     ...
     * Sets rules
     *
     * @param \PidginHost\\Sdk\Model\FirewallRule[] $rules rules
     *
     * @return self
     */
     ...
     * Sets read_only
     *
     * @param bool $read_only used with free tier vm
     *
     * @return self
     */
