...
/**
 * PaginatedPublicIPv6List Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedPublicIPv6List implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedPublicIPv6List';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\\Sdk\Model\PublicIPv6[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \PidginHost\\Sdk\Model\PublicIPv6[] $results results
     *
     * @return self
     */
