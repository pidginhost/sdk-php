 ...
 */
class ReverseDNS implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReverseDNS';
     ...
     * Sets reverse_dns
     *
     * @param string $reverse_dns Fully-qualified domain name for PTR record (e.g., host.example.com)
     *
     * @return self
     */
    public function setReverseDns($reverse_dns)
    {
        ...
        if ((mb_strlen($reverse_dns) > 200)) {
            throw new \InvalidArgumentException('invalid length for $reverse_dns when calling ReverseDNS., must be smaller than or equal to 200.');
        }
