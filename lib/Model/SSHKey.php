...
class SSHKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['key']) > 3000)) {
    ...
    public function setAlias($alias)
    {
        ...
        if ((mb_strlen($alias) > 50)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling SSHKey., must be smaller than or equal to 50.');
        }
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $key when calling SSHKey., must be smaller than or equal to 3000.');
        }
