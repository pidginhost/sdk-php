...
/**
 * PaginatedDepositList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedDepositList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedDepositList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\Deposit[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\Deposit[] $results results
     *
     * @return self
     */
