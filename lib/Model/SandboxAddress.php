...
/**
 * SandboxAddress Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class SandboxAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SandboxAddress';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['address']) > 254)) {
            $invalidProperties[] = "invalid value for 'address', the character length must be smaller than or equal to 254.";
        }
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 254)) {
            throw new \InvalidArgumentException('invalid length for $address when calling SandboxAddress., must be smaller than or equal to 254.');
        }
