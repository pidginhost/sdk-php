...
/**
 * PaginatedSandboxAddressList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedSandboxAddressList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedSandboxAddressList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\SandboxAddress[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\SandboxAddress[] $results results
     *
     * @return self
     */
