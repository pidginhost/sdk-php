...
class Profile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['funds'] === null) {
            $invalidProperties[] = "'funds' can't be null";
        }
        if (!preg_match("/^-?\\d{0,16}(?:\\.\\d{0,4})?$/", $this->container['funds'])) {
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Profile., must be smaller than or equal to 100.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Profile., must be smaller than or equal to 100.');
        }
    ...
    public function setFunds($funds)
    {
        ...
        if ((!preg_match("/^-?\\d{0,16}(?:\\.\\d{0,4})?$/", ObjectSerializer::toString($funds)))) {
            throw new \InvalidArgumentException("invalid value for \$funds when calling Profile., must conform to the pattern /^-?\\d{0,16}(?:\\.\\d{0,4})?$/.");
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 100)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Profile., must be smaller than or equal to 100.');
        }
