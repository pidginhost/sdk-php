...
/**
 * HostingService Class Doc Comment
 *
 * @category Class
 * @description Read-only serializer for shared/cPanel hosting services.
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class HostingService implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HostingService';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('node_url', $data ?? [], null);
    ...
    public function setPrice($price)
    {
        ...
        if ((!preg_match("/^-?\\d{0,8}(?:\\.\\d{0,2})?$/", ObjectSerializer::toString($price)))) {
            throw new \InvalidArgumentException("invalid value for \$price when calling HostingService., must conform to the pattern /^-?\\d{0,8}(?:\\.\\d{0,2})?$/.");
        }
