...
/**
 * PatchedFirewallRulesSet Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PatchedFirewallRulesSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedFirewallRulesSet';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'status' => '\PidginHost\\Sdk\Model\FirewallRulesSetStatusEnum',
        'rules' => '\PidginHost\\Sdk\Model\FirewallRule[]',
        'read_only' => 'bool'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedFirewallRulesSet., must be smaller than or equal to 200.');
        }
     ...
     * Gets status
     *
     * @return \PidginHost\\Sdk\Model\FirewallRulesSetStatusEnum|null
     */
     ...
     * Sets status
     *
     * @param \PidginHost\\Sdk\Model\FirewallRulesSetStatusEnum|null $status status
     *
     * @return self
     */
     ...
     * Gets rules
     *
     * @return \PidginHost\\Sdk\Model\FirewallRule[]|null
     */
     ...
     * Sets rules
     *
     * @param \PidginHost\\Sdk\Model\FirewallRule[]|null $rules rules
     *
     * @return self
     */
     ...
     * Sets read_only
     *
     * @param bool|null $read_only used with free tier vm
     *
     * @return self
     */
