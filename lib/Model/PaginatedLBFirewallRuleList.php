...
/**
 * PaginatedLBFirewallRuleList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedLBFirewallRuleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedLBFirewallRuleList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\LBFirewallRule[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\LBFirewallRule[] $results results
     *
     * @return self
     */
