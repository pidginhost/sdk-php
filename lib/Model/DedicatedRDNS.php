...
/**
 * DedicatedRDNS Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class DedicatedRDNS implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DedicatedRDNS';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ip_id'] === null) {
            $invalidProperties[] = "'ip_id' can't be null";
        }
        if ($this->container['reverse_dns'] === null) {
            $invalidProperties[] = "'reverse_dns' can't be null";
        }
        if ((mb_strlen($this->container['reverse_dns']) > 200)) {
            $invalidProperties[] = "invalid value for 'reverse_dns', the character length must be smaller than or equal to 200.";
        }
    ...
    public function setReverseDns($reverse_dns)
    {
        ...
        if ((mb_strlen($reverse_dns) > 200)) {
            throw new \InvalidArgumentException('invalid length for $reverse_dns when calling DedicatedRDNS., must be smaller than or equal to 200.');
        }
