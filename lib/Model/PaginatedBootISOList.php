...
/**
 * PaginatedBootISOList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedBootISOList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedBootISOList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\BootISO[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\BootISO[] $results results
     *
     * @return self
     */
