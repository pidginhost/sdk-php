...
class InboundRoute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['pattern']) > 128)) {
    ...
    public function setPattern($pattern)
    {
        ...
        if ((mb_strlen($pattern) > 128)) {
            throw new \InvalidArgumentException('invalid length for $pattern when calling InboundRoute., must be smaller than or equal to 128.');
        }
     ...
     * Gets mode
     *
     * @return \PidginHost\Sdk\Model\ModeEnum
     */
     ...
     * Sets mode
     *
     * @param \PidginHost\Sdk\Model\ModeEnum $mode mode
     *
     * @return self
     */
    ...
    public function setWebhookUrl($webhook_url)
    {
        ...
        if ((mb_strlen($webhook_url) > 200)) {
            throw new \InvalidArgumentException('invalid length for $webhook_url when calling InboundRoute., must be smaller than or equal to 200.');
        }
    ...
    public function setForwardTo($forward_to)
    {
        ...
        if ((mb_strlen($forward_to) > 254)) {
            throw new \InvalidArgumentException('invalid length for $forward_to when calling InboundRoute., must be smaller than or equal to 254.');
        }
