...
/**
 * ServerUpgradeResponse Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ServerUpgradeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServerUpgradeResponse';
    ...
    {
        $this->setIfExists('upgrading', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['upgrading'] === null) {
            $invalidProperties[] = "'upgrading' can't be null";
        }
    ...
    {
        return $this->container['upgrading'];
    }

    /**
     * Sets upgrading
     *
     * @param bool $upgrading upgrading
     *
     * @return self
     */
    public function setUpgrading($upgrading)
    {
        if (is_null($upgrading)) {
            throw new \InvalidArgumentException('non-nullable upgrading cannot be null');
        }
        $this->container['upgrading'] = $upgrading;
