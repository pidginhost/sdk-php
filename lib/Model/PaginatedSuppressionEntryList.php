...
/**
 * PaginatedSuppressionEntryList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedSuppressionEntryList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedSuppressionEntryList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\SuppressionEntry[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\SuppressionEntry[] $results results
     *
     * @return self
     */
