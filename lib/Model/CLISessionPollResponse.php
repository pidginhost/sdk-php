...
/**
 * CLISessionPollResponse Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CLISessionPollResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CLISessionPollResponse';
    ...
    protected static $openAPITypes = [
        'status' => '\PidginHost\Sdk\Model\CLISessionPollResponseStatusEnum',
        'token_key' => 'string',
        'token_name' => 'string',
        'token_scope' => 'string',
        'account' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('token_key', $data ?? [], null);
        $this->setIfExists('token_name', $data ?? [], null);
        $this->setIfExists('token_scope', $data ?? [], null);
     ...
     * Gets status
     *
     * @return \PidginHost\Sdk\Model\CLISessionPollResponseStatusEnum
     */
     ...
     * Sets status
     *
     * @param \PidginHost\Sdk\Model\CLISessionPollResponseStatusEnum $status status
     *
     * @return self
     */
     ...
     * Sets token_key
     *
     * @param string|null $token_key Only present when status is approved
     *
     * @return self
     */
    public function setTokenKey($token_key)
    {
        if (is_null($token_key)) {
            throw new \InvalidArgumentException('non-nullable token_key cannot be null');
        }
     ...
     * Sets token_scope
     *
     * @param string|null $token_scope token_scope
     *
     * @return self
     */
     ...
     * Sets account
     *
     * @param string|null $account Bound account, when the token is membership-bound
     *
     * @return self
     */
