...
/**
 * AttachIPv6Request Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class AttachIPv6Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AttachIPv6Request';
     ...
     * Sets ipv6
     *
     * @param string $ipv6 ID or address of an IPv6 you own.
     *
     * @return self
     */
     ...
     * Sets reboot
     *
     * @param bool|null $reboot Restart the server so the guest OS picks up the address.
     *
     * @return self
     */
