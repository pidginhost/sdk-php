...
/**
 * PaginatedPublicIPv4List Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedPublicIPv4List implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedPublicIPv4List';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\\Sdk\Model\PublicIPv4[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \PidginHost\\Sdk\Model\PublicIPv4[] $results results
     *
     * @return self
     */
