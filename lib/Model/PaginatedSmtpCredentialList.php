...
/**
 * PaginatedSmtpCredentialList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedSmtpCredentialList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedSmtpCredentialList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\SmtpCredential[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\SmtpCredential[] $results results
     *
     * @return self
     */
