...
/**
 * TransferRoDomain Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class TransferRoDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferRoDomain';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['auth_code']) > 255)) {
            $invalidProperties[] = "invalid value for 'auth_code', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 255)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling TransferRoDomain., must be smaller than or equal to 255.');
        }
    ...
    public function setAuthCode($auth_code)
    {
        ...
        if ((mb_strlen($auth_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $auth_code when calling TransferRoDomain., must be smaller than or equal to 255.');
        }
