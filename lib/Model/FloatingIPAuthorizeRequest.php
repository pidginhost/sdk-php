...
/**
 * FloatingIPAuthorizeRequest Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class FloatingIPAuthorizeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FloatingIPAuthorizeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['server_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'server_id', must be bigger than or equal to 1.";
        }
    ...
    public function setServerId($server_id)
    {
        ...
        if (($server_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $server_id when calling FloatingIPAuthorizeRequest., must be bigger than or equal to 1.');
        }
