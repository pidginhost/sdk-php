...
/**
 * PatchedPrivateNetwork Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PatchedPrivateNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedPrivateNetwork';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['address']) && (mb_strlen($this->container['address']) > 32)) {
     ...
     * Sets slug
     *
     * @param string|null $slug CIDR format
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address CIDR format
     *
     * @return self
     */
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 32)) {
            throw new \InvalidArgumentException('invalid length for $address when calling PatchedPrivateNetwork., must be smaller than or equal to 32.');
        }
     ...
     * Sets provisioned
     *
     * @param bool|null $provisioned provisioned
     *
     * @return self
     */
     ...
     * Sets servers
     *
     * @param array<string,string>[]|null $servers servers
     *
     * @return self
     */
