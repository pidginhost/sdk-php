...
/**
 * PaginatedK8sPortForwardList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedK8sPortForwardList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedK8sPortForwardList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\K8sPortForward[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\K8sPortForward[] $results results
     *
     * @return self
     */
