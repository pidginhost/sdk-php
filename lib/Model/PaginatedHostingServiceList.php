...
/**
 * PaginatedHostingServiceList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedHostingServiceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedHostingServiceList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\HostingService[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\HostingService[] $results results
     *
     * @return self
     */
