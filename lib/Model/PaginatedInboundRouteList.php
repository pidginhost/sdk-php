...
/**
 * PaginatedInboundRouteList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedInboundRouteList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedInboundRouteList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\InboundRoute[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\InboundRoute[] $results results
     *
     * @return self
     */
