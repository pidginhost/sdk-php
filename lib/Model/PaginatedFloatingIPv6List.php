...
/**
 * PaginatedFloatingIPv6List Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedFloatingIPv6List implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedFloatingIPv6List';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\FloatingIPv6[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\FloatingIPv6[] $results results
     *
     * @return self
     */
