...
/**
 * PaginatedSendingDomainList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedSendingDomainList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedSendingDomainList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\SendingDomain[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\SendingDomain[] $results results
     *
     * @return self
     */
