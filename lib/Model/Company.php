...
class Company implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCifVat($cif_vat)
    {
        ...
        if ((mb_strlen($cif_vat) > 50)) {
            throw new \InvalidArgumentException('invalid length for $cif_vat when calling Company., must be smaller than or equal to 50.');
        }
    ...
    public function setReg($reg)
    {
        ...
        if ((mb_strlen($reg) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reg when calling Company., must be smaller than or equal to 100.');
        }
    ...
    public function setIban($iban)
    {
        ...
        if ((mb_strlen($iban) > 100)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling Company., must be smaller than or equal to 100.');
        }
    ...
    public function setBank($bank)
    {
        ...
        if ((mb_strlen($bank) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bank when calling Company., must be smaller than or equal to 100.');
        }
    ...
    public function setContactName($contact_name)
    {
        ...
        if ((mb_strlen($contact_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $contact_name when calling Company., must be smaller than or equal to 100.');
        }
    ...
    public function setContactEmail($contact_email)
    {
        ...
        if ((mb_strlen($contact_email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $contact_email when calling Company., must be smaller than or equal to 100.');
        }
