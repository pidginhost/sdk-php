...
class Service implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['terminated'] === null && !$this->isNullableSetToNull('terminated')) {
            $invalidProperties[] = "'terminated' is required";
        }
        if ($this->container['next_invoice'] === null) {
            $invalidProperties[] = "'next_invoice' can't be null";
        }
        if ($this->container['primary_service'] === null && !$this->isNullableSetToNull('primary_service')) {
            $invalidProperties[] = "'primary_service' is required";
        }
     ...
     *
     * @param int|null $primary_service primary_service
     *
     * @return self
     */
