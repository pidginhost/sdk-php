...
/**
 * PaginatedApiCredentialList Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedApiCredentialList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaginatedApiCredentialList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\PidginHost\Sdk\Model\ApiCredential[]'
    ];
     ...
     * Sets results
     *
     * @param \PidginHost\Sdk\Model\ApiCredential[] $results results
     *
     * @return self
     */
