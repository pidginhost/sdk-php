...
/**
 * BucketCancelResponse Class Doc Comment
 *
 * @category Class
 * @description Body of the 202 answered by &#x60;&#x60;BucketViewSet.destroy&#x60;&#x60;.  Deletion is asynchronous, so the route cannot answer 204: the caller needs the id it cancelled and the status it moved to.
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BucketCancelResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BucketCancelResponse';
