...
class ChangePassword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 100)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ChangePassword., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($password) < 6)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ChangePassword., must be bigger than or equal to 6.');
        }
