...
/**
 * ServerDetachIPv4Response Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ServerDetachIPv4Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ServerDetachIPv4Response';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['detached'] === null) {
            $invalidProperties[] = "'detached' can't be null";
        }
