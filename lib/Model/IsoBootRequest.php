...
/**
 * IsoBootRequest Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class IsoBootRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IsoBootRequest';
     ...
     * Sets iso
     *
     * @param string|null $iso Catalog ISO slug. Omit it to use the default rescue image.
     *
     * @return self
     */
