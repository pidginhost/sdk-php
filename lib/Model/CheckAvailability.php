...
/**
 * CheckAvailability Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CheckAvailability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckAvailability';
    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 255)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling CheckAvailability., must be smaller than or equal to 255.');
        }
