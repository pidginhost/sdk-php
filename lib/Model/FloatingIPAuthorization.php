...
/**
 * FloatingIPAuthorization Class Doc Comment
 *
 * @category Class
 * @description Read-only authorization row for either v4 or v6 (shape is identical).
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FloatingIPAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FloatingIPAuthorization';
     ...
     *
     * @param string $server_hostname server_hostname
     *
     * @return self
     */
