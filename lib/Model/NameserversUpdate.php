...
/**
 * NameserversUpdate Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class NameserversUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NameserversUpdate';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['nameservers']) > 5)) {
            $invalidProperties[] = "invalid value for 'nameservers', number of items must be less than or equal to 5.";
        }
     ...
     * Sets nameservers
     *
     * @param string[] $nameservers List of 2-5 nameserver hostnames
     *
     * @return self
     */
    public function setNameservers($nameservers)
    {
        ...
        if ((count($nameservers) > 5)) {
            throw new \InvalidArgumentException('invalid value for $nameservers when calling NameserversUpdate., number of items must be less than or equal to 5.');
        }
        if ((count($nameservers) < 2)) {
            throw new \InvalidArgumentException('invalid length for $nameservers when calling NameserversUpdate., number of items must be greater than or equal to 2.');
        }
