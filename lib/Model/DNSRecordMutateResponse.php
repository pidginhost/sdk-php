...
/**
 * DNSRecordMutateResponse Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class DNSRecordMutateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DNSRecordMutateResponse';
    ...
    protected static $openAPITypes = [
        'message' => 'string',
        'record' => '\PidginHost\Sdk\Model\DNSRecord'
    ];
     ...
     * Gets record
     *
     * @return \PidginHost\Sdk\Model\DNSRecord|null
     */
     ...
     * Sets record
     *
     * @param \PidginHost\Sdk\Model\DNSRecord|null $record record
     *
     * @return self
     */
