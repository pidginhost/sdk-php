 ...
 */
class RenewDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RenewDomain';
    ...
    */
    ...
    public function setYears($years)
    {
        ...
        if (($years < 1)) {
            throw new \InvalidArgumentException('invalid value for $years when calling RenewDomain., must be bigger than or equal to 1.');
        }
