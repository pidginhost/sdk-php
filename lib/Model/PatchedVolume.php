...
/**
 * PatchedVolume Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PatchedVolume implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedVolume';
    ...
    */
    ...
    public function setProject($project)
    {
        ...
        if ((mb_strlen($project) > 200)) {
            throw new \InvalidArgumentException('invalid length for $project when calling PatchedVolume., must be smaller than or equal to 200.');
        }
    ...
    public function setAlias($alias)
    {
        ...
        if ((mb_strlen($alias) > 50)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling PatchedVolume., must be smaller than or equal to 50.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PatchedVolume., must be smaller than or equal to 2147483647.');
        }
        if (($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling PatchedVolume., must be bigger than or equal to 0.');
        }
     ...
     * Sets product
     *
     * @param string|null $product ID or slug
     *
     * @return self
     */
