...
/**
 * PatchedSSHKey Class Doc Comment
 *
 * @category Class
 * @package  PidginHost\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class PatchedSSHKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedSSHKey';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['key']) && (mb_strlen($this->container['key']) > 3000)) {
            $invalidProperties[] = "invalid value for 'key', the character length must be smaller than or equal to 3000.";
        }
    ...
    public function setAlias($alias)
    {
        ...
        if ((mb_strlen($alias) > 50)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling PatchedSSHKey., must be smaller than or equal to 50.');
        }
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $key when calling PatchedSSHKey., must be smaller than or equal to 3000.');
        }
