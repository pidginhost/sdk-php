...
class SchemaApi
{
    ...
    /**
     * Operation schemaRetrieve2
     *
     * @param  string|null $format format (optional)
     * @param  string|null $lang lang (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['schemaRetrieve2'] to see the possible values for this operation
     *
     * @throws \PidginHost\\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<string,mixed>
     */
    public function schemaRetrieve2($format = null, $lang = null, string $contentType = self::contentTypes['schemaRetrieve2'][0])
    {
        list($response) = $this->schemaRetrieve2WithHttpInfo($format, $lang, $contentType);
        return $response;
    }

    /**
     * Operation schemaRetrieve2WithHttpInfo
     *
     * @param  string|null $format (optional)
     * @param  string|null $lang (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['schemaRetrieve2'] to see the possible values for this operation
     ...
     * @return array of array<string,mixed>, HTTP status code, HTTP response headers (array of strings)
     */
    public function schemaRetrieve2WithHttpInfo($format = null, $lang = null, string $contentType = self::contentTypes['schemaRetrieve2'][0])
    {
        $request = $this->schemaRetrieve2Request($format, $lang, $contentType);
    ...
    /**
     * Operation schemaRetrieve2Async
     *
     * @param  string|null $format (optional)
     * @param  string|null $lang (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['schemaRetrieve2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function schemaRetrieve2Async($format = null, $lang = null, string $contentType = self::contentTypes['schemaRetrieve2'][0])
    {
        return $this->schemaRetrieve2AsyncWithHttpInfo($format, $lang, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation schemaRetrieve2AsyncWithHttpInfo
     *
     * @param  string|null $format (optional)
     * @param  string|null $lang (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['schemaRetrieve2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function schemaRetrieve2AsyncWithHttpInfo($format = null, $lang = null, string $contentType = self::contentTypes['schemaRetrieve2'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->schemaRetrieve2Request($format, $lang, $contentType);
    ...
    /**
     * Create request for operation 'schemaRetrieve2'
     *
     * @param  string|null $format (optional)
     * @param  string|null $lang (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['schemaRetrieve2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function schemaRetrieve2Request($format = null, $lang = null, string $contentType = self::contentTypes['schemaRetrieve2'][0])
    {




        $resourcePath = '/api/v1/schema/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
