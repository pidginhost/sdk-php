...
class DomainApi
{
    ...
    /**
     * Operation domainDomainCancelCreate2
     *
     * @param  string $domain domain (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainCancelCreate2'] to see the possible values for this operation
     *
     * @throws \PidginHost\\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PidginHost\\Sdk\Model\DomainCancelResponse
     */
    public function domainDomainCancelCreate2($domain, string $contentType = self::contentTypes['domainDomainCancelCreate2'][0])
    {
        list($response) = $this->domainDomainCancelCreate2WithHttpInfo($domain, $contentType);
        return $response;
    }

    /**
     * Operation domainDomainCancelCreate2WithHttpInfo
     *
     * @param  string $domain (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainCancelCreate2'] to see the possible values for this operation
     *
     ...
     * @return array of \PidginHost\\Sdk\Model\DomainCancelResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function domainDomainCancelCreate2WithHttpInfo($domain, string $contentType = self::contentTypes['domainDomainCancelCreate2'][0])
    {
        $request = $this->domainDomainCancelCreate2Request($domain, $contentType);
    ...
    /**
     * Operation domainDomainCancelCreate2Async
     *
     * @param  string $domain (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainCancelCreate2'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainCancelCreate2Async($domain, string $contentType = self::contentTypes['domainDomainCancelCreate2'][0])
    {
        return $this->domainDomainCancelCreate2AsyncWithHttpInfo($domain, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation domainDomainCancelCreate2AsyncWithHttpInfo
     *
     * @param  string $domain (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainCancelCreate2'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainCancelCreate2AsyncWithHttpInfo($domain, string $contentType = self::contentTypes['domainDomainCancelCreate2'][0])
    {
        $returnType = '\PidginHost\\Sdk\Model\DomainCancelResponse';
        $request = $this->domainDomainCancelCreate2Request($domain, $contentType);
    ...
    /**
     * Create request for operation 'domainDomainCancelCreate2'
     *
     * @param  string $domain (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainCancelCreate2'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function domainDomainCancelCreate2Request($domain, string $contentType = self::contentTypes['domainDomainCancelCreate2'][0])
    {

        // verify the required parameter 'domain' is set
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling domainDomainCancelCreate2'
            );
        }
        if (!preg_match("/^[^\/]+$/", $domain)) {
            throw new \InvalidArgumentException("invalid value for \"domain\" when calling DomainApi.domainDomainCancelCreate2, must conform to the pattern /^[^\/]+$/.");
        }
        

        $resourcePath = '/api/v1/domain/domain/{domain}/cancel/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation domainDomainContactsCreate2
     *
     * @param  string $domain domain (required)
     * @param  \PidginHost\\Sdk\Model\ContactsUpdate $contacts_update contacts_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainContactsCreate2'] to see the possible values for this operation
     *
     * @throws \PidginHost\\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PidginHost\\Sdk\Model\ContactsUpdateResponse
     */
    public function domainDomainContactsCreate2($domain, $contacts_update, string $contentType = self::contentTypes['domainDomainContactsCreate2'][0])
    {
        list($response) = $this->domainDomainContactsCreate2WithHttpInfo($domain, $contacts_update, $contentType);
        return $response;
    }

    /**
     * Operation domainDomainContactsCreate2WithHttpInfo
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\ContactsUpdate $contacts_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainContactsCreate2'] to see the possible values for this operation
     ...
     * @return array of \PidginHost\\Sdk\Model\ContactsUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function domainDomainContactsCreate2WithHttpInfo($domain, $contacts_update, string $contentType = self::contentTypes['domainDomainContactsCreate2'][0])
    {
        $request = $this->domainDomainContactsCreate2Request($domain, $contacts_update, $contentType);
    ...
    /**
     * Operation domainDomainContactsCreate2Async
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\ContactsUpdate $contacts_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainContactsCreate2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainContactsCreate2Async($domain, $contacts_update, string $contentType = self::contentTypes['domainDomainContactsCreate2'][0])
    {
        return $this->domainDomainContactsCreate2AsyncWithHttpInfo($domain, $contacts_update, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation domainDomainContactsCreate2AsyncWithHttpInfo
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\ContactsUpdate $contacts_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainContactsCreate2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainContactsCreate2AsyncWithHttpInfo($domain, $contacts_update, string $contentType = self::contentTypes['domainDomainContactsCreate2'][0])
    {
        $returnType = '\PidginHost\\Sdk\Model\ContactsUpdateResponse';
        $request = $this->domainDomainContactsCreate2Request($domain, $contacts_update, $contentType);
    ...
    /**
     * Create request for operation 'domainDomainContactsCreate2'
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\ContactsUpdate $contacts_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainContactsCreate2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function domainDomainContactsCreate2Request($domain, $contacts_update, string $contentType = self::contentTypes['domainDomainContactsCreate2'][0])
    {

        // verify the required parameter 'domain' is set
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling domainDomainContactsCreate2'
            );
        }
        if (!preg_match("/^[^\/]+$/", $domain)) {
            throw new \InvalidArgumentException("invalid value for \"domain\" when calling DomainApi.domainDomainContactsCreate2, must conform to the pattern /^[^\/]+$/.");
        }
        
        // verify the required parameter 'contacts_update' is set
        if ($contacts_update === null || (is_array($contacts_update) && count($contacts_update) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contacts_update when calling domainDomainContactsCreate2'
            );
        }


        $resourcePath = '/api/v1/domain/domain/{domain}/contacts/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation domainDomainNameserversCreate2
     *
     * @param  string $domain domain (required)
     * @param  \PidginHost\\Sdk\Model\NameserversUpdate $nameservers_update nameservers_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainNameserversCreate2'] to see the possible values for this operation
     *
     * @throws \PidginHost\\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PidginHost\\Sdk\Model\NameserversUpdateResponse
     */
    public function domainDomainNameserversCreate2($domain, $nameservers_update, string $contentType = self::contentTypes['domainDomainNameserversCreate2'][0])
    {
        list($response) = $this->domainDomainNameserversCreate2WithHttpInfo($domain, $nameservers_update, $contentType);
        return $response;
    }

    /**
     * Operation domainDomainNameserversCreate2WithHttpInfo
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\NameserversUpdate $nameservers_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainNameserversCreate2'] to see the possible values for this operation
     ...
     * @return array of \PidginHost\\Sdk\Model\NameserversUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function domainDomainNameserversCreate2WithHttpInfo($domain, $nameservers_update, string $contentType = self::contentTypes['domainDomainNameserversCreate2'][0])
    {
        $request = $this->domainDomainNameserversCreate2Request($domain, $nameservers_update, $contentType);
    ...
    /**
     * Operation domainDomainNameserversCreate2Async
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\NameserversUpdate $nameservers_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainNameserversCreate2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainNameserversCreate2Async($domain, $nameservers_update, string $contentType = self::contentTypes['domainDomainNameserversCreate2'][0])
    {
        return $this->domainDomainNameserversCreate2AsyncWithHttpInfo($domain, $nameservers_update, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation domainDomainNameserversCreate2AsyncWithHttpInfo
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\NameserversUpdate $nameservers_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainNameserversCreate2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainNameserversCreate2AsyncWithHttpInfo($domain, $nameservers_update, string $contentType = self::contentTypes['domainDomainNameserversCreate2'][0])
    {
        $returnType = '\PidginHost\\Sdk\Model\NameserversUpdateResponse';
        $request = $this->domainDomainNameserversCreate2Request($domain, $nameservers_update, $contentType);
    ...
    /**
     * Create request for operation 'domainDomainNameserversCreate2'
     *
     * @param  string $domain (required)
     * @param  \PidginHost\\Sdk\Model\NameserversUpdate $nameservers_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainNameserversCreate2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function domainDomainNameserversCreate2Request($domain, $nameservers_update, string $contentType = self::contentTypes['domainDomainNameserversCreate2'][0])
    {

        // verify the required parameter 'domain' is set
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling domainDomainNameserversCreate2'
            );
        }
        if (!preg_match("/^[^\/]+$/", $domain)) {
            throw new \InvalidArgumentException("invalid value for \"domain\" when calling DomainApi.domainDomainNameserversCreate2, must conform to the pattern /^[^\/]+$/.");
        }
        
        // verify the required parameter 'nameservers_update' is set
        if ($nameservers_update === null || (is_array($nameservers_update) && count($nameservers_update) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $nameservers_update when calling domainDomainNameserversCreate2'
            );
        }


        $resourcePath = '/api/v1/domain/domain/{domain}/nameservers/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
