...
class DomainApi
{
    ...
    public function domainDomainDnsCreateRequest($domain, $dns_glue, string $contentType = self::contentTypes['domainDomainDnsCreate'][0])
    {
        ...
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling domainDomainDnsCreate'
            );
        }
        if (!preg_match("/^[^\/]+$/", $domain)) {
        ...
        $resourcePath = '/api/domain/domain/{domain}/dns/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation domainDomainDnsDestroy
     *
     * @param  string $domain domain (required)
     * @param  string $name name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsDestroy'] to see the possible values for this operation
     *
     * @throws \PidginHost\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function domainDomainDnsDestroy($domain, $name, string $contentType = self::contentTypes['domainDomainDnsDestroy'][0])
    {
        $this->domainDomainDnsDestroyWithHttpInfo($domain, $name, $contentType);
    }

    /**
     * Operation domainDomainDnsDestroyWithHttpInfo
     *
     * @param  string $domain (required)
     ...
     */
    public function domainDomainDnsDestroyWithHttpInfo($domain, $name, string $contentType = self::contentTypes['domainDomainDnsDestroy'][0])
    {
        $request = $this->domainDomainDnsDestroyRequest($domain, $name, $contentType);
    ...
    /**
     * Operation domainDomainDnsDestroyAsync
     *
     * @param  string $domain (required)
     * @param  string $name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsDestroy'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainDnsDestroyAsync($domain, $name, string $contentType = self::contentTypes['domainDomainDnsDestroy'][0])
    {
        return $this->domainDomainDnsDestroyAsyncWithHttpInfo($domain, $name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation domainDomainDnsDestroyAsyncWithHttpInfo
     *
     * @param  string $domain (required)
     * @param  string $name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsDestroy'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainDnsDestroyAsyncWithHttpInfo($domain, $name, string $contentType = self::contentTypes['domainDomainDnsDestroy'][0])
    {
        $returnType = '';
        $request = $this->domainDomainDnsDestroyRequest($domain, $name, $contentType);
    ...
    /**
     * Create request for operation 'domainDomainDnsDestroy'
     *
     * @param  string $domain (required)
     * @param  string $name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsDestroy'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function domainDomainDnsDestroyRequest($domain, $name, string $contentType = self::contentTypes['domainDomainDnsDestroy'][0])
    {

        // verify the required parameter 'domain' is set
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling domainDomainDnsDestroy'
            );
        }
        if (!preg_match("/^[^\/]+$/", $domain)) {
            throw new \InvalidArgumentException("invalid value for \"domain\" when calling DomainApi.domainDomainDnsDestroy, must conform to the pattern /^[^\/]+$/.");
        }
        
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling domainDomainDnsDestroy'
            );
        }
        if (!preg_match("/^[^\/]+$/", $name)) {
            throw new \InvalidArgumentException("invalid value for \"name\" when calling DomainApi.domainDomainDnsDestroy, must conform to the pattern /^[^\/]+$/.");
        }
        

        $resourcePath = '/api/domain/domain/{domain}/dns/{name}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation domainDomainDnsList
     *
     * @param  string $domain domain (required)
     * @param  int|null $page A page number within the paginated result set. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsList'] to see the possible values for this operation
     *
     * @throws \PidginHost\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PidginHost\Sdk\Model\PaginatedDNSGlueList
     */
    public function domainDomainDnsList($domain, $page = null, string $contentType = self::contentTypes['domainDomainDnsList'][0])
    {
        list($response) = $this->domainDomainDnsListWithHttpInfo($domain, $page, $contentType);
        return $response;
    }

    /**
     * Operation domainDomainDnsListWithHttpInfo
     *
     * @param  string $domain (required)
     * @param  int|null $page A page number within the paginated result set. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsList'] to see the possible values for this operation
     ...
     * @throws \PidginHost\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PidginHost\Sdk\Model\PaginatedDNSGlueList, HTTP status code, HTTP response headers (array of strings)
     */
    public function domainDomainDnsListWithHttpInfo($domain, $page = null, string $contentType = self::contentTypes['domainDomainDnsList'][0])
    {
        $request = $this->domainDomainDnsListRequest($domain, $page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PidginHost\Sdk\Model\PaginatedDNSGlueList',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation domainDomainDnsListAsync
     *
     * @param  string $domain (required)
     * @param  int|null $page A page number within the paginated result set. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsList'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainDnsListAsync($domain, $page = null, string $contentType = self::contentTypes['domainDomainDnsList'][0])
    {
        return $this->domainDomainDnsListAsyncWithHttpInfo($domain, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation domainDomainDnsListAsyncWithHttpInfo
     *
     * @param  string $domain (required)
     * @param  int|null $page A page number within the paginated result set. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsList'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function domainDomainDnsListAsyncWithHttpInfo($domain, $page = null, string $contentType = self::contentTypes['domainDomainDnsList'][0])
    {
        $returnType = '\PidginHost\Sdk\Model\PaginatedDNSGlueList';
        $request = $this->domainDomainDnsListRequest($domain, $page, $contentType);
    ...
    /**
     * Create request for operation 'domainDomainDnsList'
     *
     * @param  string $domain (required)
     * @param  int|null $page A page number within the paginated result set. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['domainDomainDnsList'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function domainDomainDnsListRequest($domain, $page = null, string $contentType = self::contentTypes['domainDomainDnsList'][0])
    {

        // verify the required parameter 'domain' is set
        if ($domain === null || (is_array($domain) && count($domain) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain when calling domainDomainDnsList'
            );
        }
        if (!preg_match("/^[^\/]+$/", $domain)) {
            throw new \InvalidArgumentException("invalid value for \"domain\" when calling DomainApi.domainDomainDnsList, must conform to the pattern /^[^\/]+$/.");
        }
