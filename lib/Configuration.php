...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://www.pidginhost.com';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.12.2/PHP';
    ...
    {
        $report  = 'PHP SDK (PidginHost\Sdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0 (v1)' . PHP_EOL;
        $report .= '    SDK Package Version: 0.12.2' . PHP_EOL;
