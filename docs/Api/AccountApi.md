...
```php
accountApiTokensCreate2($api_token_create): \PidginHost\\Sdk\Model\APITokenCreate
```
...
try {
    $result = $apiInstance->accountApiTokensCreate2($api_token_create);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AccountApi->accountApiTokensCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->accountApiTokensDestroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling AccountApi->accountApiTokensDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
accountApiTokensList2($page): \PidginHost\\Sdk\Model\PaginatedAPITokenListList
```
...
try {
    $result = $apiInstance->accountApiTokensList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AccountApi->accountApiTokensList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
accountCompaniesCreate2($company): \PidginHost\\Sdk\Model\Company
```
...
try {
    $result = $apiInstance->accountCompaniesCreate2($company);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AccountApi->accountCompaniesCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->accountCompaniesDestroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling AccountApi->accountCompaniesDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
accountEmailsList2($page): \PidginHost\\Sdk\Model\PaginatedEmailHistoryList
```
...
try {
    $result = $apiInstance->accountEmailsList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AccountApi->accountEmailsList2: ', $e->getMessage(), PHP_EOL;
}
```
