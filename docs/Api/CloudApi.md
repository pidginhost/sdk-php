...
try {
    $apiInstance->cloudServersPartialUpdate($id);
} catch (Exception $e) {
...
try {
    $apiInstance->cloudServersPartialUpdate2($id);
} catch (Exception $e) {
...
try {
    $apiInstance->cloudServersRetrieve($id);
} catch (Exception $e) {
...
try {
    $apiInstance->cloudServersRetrieve2($id);
} catch (Exception $e) {
...
try {
    $apiInstance->cloudServersUpdate($id);
} catch (Exception $e) {
...
try {
    $apiInstance->cloudServersUpdate2($id);
} catch (Exception $e) {
