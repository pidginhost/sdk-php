...
```php
cloudFloatingIpv4AuthorizationsRetrieve($id): \PidginHost\Sdk\Model\FloatingIPv4
```
...
try {
    $result = $apiInstance->cloudFloatingIpv4AuthorizationsRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFloatingIpv4AuthorizationsRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFloatingIpv6AuthorizationsRetrieve($id): \PidginHost\Sdk\Model\FloatingIPv6
```
...
try {
    $result = $apiInstance->cloudFloatingIpv6AuthorizationsRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFloatingIpv6AuthorizationsRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersAttachIpv4Create($id, $attach_ipv4): \PidginHost\Sdk\Model\AttachIPv4Response
```
...
```php
cloudServersDetachIpv4Create($id, $ipv4, $server): \PidginHost\Sdk\Model\DetachIPv4Response
```
...
try {
    $result = $apiInstance->cloudServersDetachIpv4Create($id, $ipv4, $server);
    print_r($result);
} catch (Exception $e) {
