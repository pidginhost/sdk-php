...
```php
cloudFirewallRulesSetCreate2($firewall_rules_set): \PidginHost\\Sdk\Model\FirewallRulesSet
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetCreate2($firewall_rules_set);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetDestroy2($id)
```
...
try {
    $apiInstance->cloudFirewallRulesSetDestroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetList2(): \PidginHost\\Sdk\Model\FirewallRulesSet[]
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetList2();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetPartialUpdate2($id, $patched_firewall_rules_set): \PidginHost\\Sdk\Model\FirewallRulesSet
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetPartialUpdate2($id, $patched_firewall_rules_set);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetPartialUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetRetrieve2($id): \PidginHost\\Sdk\Model\FirewallRulesSet
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetRulesCreate2($rules_set_id, $firewall_rule): \PidginHost\\Sdk\Model\FirewallRule
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetRulesCreate2($rules_set_id, $firewall_rule);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetRulesCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetRulesDestroy2($rule_id, $rules_set_id)
```
...
try {
    $apiInstance->cloudFirewallRulesSetRulesDestroy2($rule_id, $rules_set_id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetRulesDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetRulesList2($rules_set_id): \PidginHost\\Sdk\Model\FirewallRule[]
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetRulesList2($rules_set_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetRulesList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetRulesPartialUpdate2($rule_id, $rules_set_id, $patched_firewall_rule): \PidginHost\\Sdk\Model\FirewallRule
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetRulesPartialUpdate2($rule_id, $rules_set_id, $patched_firewall_rule);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetRulesPartialUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetRulesRetrieve2($rule_id, $rules_set_id): \PidginHost\\Sdk\Model\FirewallRule
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetRulesRetrieve2($rule_id, $rules_set_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetRulesRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetRulesUpdate2($rule_id, $rules_set_id, $firewall_rule): \PidginHost\\Sdk\Model\FirewallRule
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetRulesUpdate2($rule_id, $rules_set_id, $firewall_rule);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetRulesUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudFirewallRulesSetUpdate2($id, $firewall_rules_set): \PidginHost\\Sdk\Model\FirewallRulesSet
```
...
try {
    $result = $apiInstance->cloudFirewallRulesSetUpdate2($id, $firewall_rules_set);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudFirewallRulesSetUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudImagesList2($page): \PidginHost\\Sdk\Model\PaginatedOSImageList
```
...
try {
    $result = $apiInstance->cloudImagesList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudImagesList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudImagesRetrieve2($id): \PidginHost\\Sdk\Model\OSImage
```
...
try {
    $result = $apiInstance->cloudImagesRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudImagesRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv4Create2($public_ipv4): \PidginHost\\Sdk\Model\PublicIPv4
```
...
try {
    $result = $apiInstance->cloudIpv4Create2($public_ipv4);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv4Create2: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->cloudIpv4Destroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv4Destroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv4DetachCreate2($id, $public_ipv4): \PidginHost\\Sdk\Model\DetachIPv4Response
```
...
try {
    $result = $apiInstance->cloudIpv4DetachCreate2($id, $public_ipv4);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv4DetachCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv4List2($page): \PidginHost\\Sdk\Model\PaginatedPublicIPv4List
```
...
try {
    $result = $apiInstance->cloudIpv4List2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv4List2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv4RdnsCreate2($id, $reverse_dns): \PidginHost\\Sdk\Model\ReverseDNS
```
...
try {
    $result = $apiInstance->cloudIpv4RdnsCreate2($id, $reverse_dns);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv4RdnsCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv4RdnsRetrieve2($id): \PidginHost\\Sdk\Model\ReverseDNS
```
...
try {
    $result = $apiInstance->cloudIpv4RdnsRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv4RdnsRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv4Retrieve2($id): \PidginHost\\Sdk\Model\PublicIPv4
```
...
try {
    $result = $apiInstance->cloudIpv4Retrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv4Retrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv6Create2($public_ipv6): \PidginHost\\Sdk\Model\PublicIPv6
```
...
try {
    $result = $apiInstance->cloudIpv6Create2($public_ipv6);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv6Create2: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->cloudIpv6Destroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv6Destroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv6DetachCreate2($id, $public_ipv6): \PidginHost\\Sdk\Model\DetachIPv6Response
```
...
try {
    $result = $apiInstance->cloudIpv6DetachCreate2($id, $public_ipv6);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv6DetachCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv6List2($page): \PidginHost\\Sdk\Model\PaginatedPublicIPv6List
```
...
try {
    $result = $apiInstance->cloudIpv6List2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv6List2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv6RdnsCreate2($id, $reverse_dns): \PidginHost\\Sdk\Model\ReverseDNS
```
...
try {
    $result = $apiInstance->cloudIpv6RdnsCreate2($id, $reverse_dns);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv6RdnsCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv6RdnsRetrieve2($id): \PidginHost\\Sdk\Model\ReverseDNS
```
...
try {
    $result = $apiInstance->cloudIpv6RdnsRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv6RdnsRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudIpv6Retrieve2($id): \PidginHost\\Sdk\Model\PublicIPv6
```
...
try {
    $result = $apiInstance->cloudIpv6Retrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudIpv6Retrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksAddServerCreate2($id, $private_network_add_host): \PidginHost\\Sdk\Model\AddServerResponse
```
...
try {
    $result = $apiInstance->cloudPrivateNetworksAddServerCreate2($id, $private_network_add_host);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksAddServerCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksCreate2($private_network): \PidginHost\\Sdk\Model\PrivateNetwork
```
...
try {
    $result = $apiInstance->cloudPrivateNetworksCreate2($private_network);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksDestroy2($id)
```
...
try {
    $apiInstance->cloudPrivateNetworksDestroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksList2($page): \PidginHost\\Sdk\Model\PaginatedPrivateNetworkList
```
...
try {
    $result = $apiInstance->cloudPrivateNetworksList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksPartialUpdate2($id, $patched_private_network): \PidginHost\\Sdk\Model\PrivateNetwork
```
...
try {
    $result = $apiInstance->cloudPrivateNetworksPartialUpdate2($id, $patched_private_network);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksPartialUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksRemoveServerCreate2($id, $private_network_remove_host): \PidginHost\\Sdk\Model\RemoveServerResponse
```
...
try {
    $result = $apiInstance->cloudPrivateNetworksRemoveServerCreate2($id, $private_network_remove_host);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksRemoveServerCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksRetrieve2($id): \PidginHost\\Sdk\Model\PrivateNetwork
```
...
try {
    $result = $apiInstance->cloudPrivateNetworksRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudPrivateNetworksUpdate2($id, $private_network): \PidginHost\\Sdk\Model\PrivateNetwork
```
...
try {
    $result = $apiInstance->cloudPrivateNetworksUpdate2($id, $private_network);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudPrivateNetworksUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServerPackagesList2($page): \PidginHost\\Sdk\Model\PaginatedServerProductList
```
...
try {
    $result = $apiInstance->cloudServerPackagesList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServerPackagesList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServerPackagesRetrieve2($id): \PidginHost\\Sdk\Model\ServerProduct
```
...
try {
    $result = $apiInstance->cloudServerPackagesRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServerPackagesRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersActivityRetrieve2($id): \PidginHost\\Sdk\Model\ActivityLogResponse
```
...
try {
    $result = $apiInstance->cloudServersActivityRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersActivityRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersAttachIpv4Create2($id, $attach_ipv4): \PidginHost\\Sdk\Model\AttachIPv4
```
...
try {
    $result = $apiInstance->cloudServersAttachIpv4Create2($id, $attach_ipv4);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersAttachIpv4Create2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersAttachIpv6Create2($id, $attach_ipv6): \PidginHost\\Sdk\Model\AttachIPv6
```
...
try {
    $result = $apiInstance->cloudServersAttachIpv6Create2($id, $attach_ipv6);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersAttachIpv6Create2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersConsoleCreate2($id, $server): \PidginHost\\Sdk\Model\ConsoleToken
```
...
try {
    $result = $apiInstance->cloudServersConsoleCreate2($id, $server);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersConsoleCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersCreate2($server_add): \PidginHost\\Sdk\Model\ServerAddResponse
```
...
try {
    $result = $apiInstance->cloudServersCreate2($server_add);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->cloudServersDestroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersDestroyProtectionCreate2($id, $destroy_protection): \PidginHost\\Sdk\Model\DestroyProtection
```
...
try {
    $result = $apiInstance->cloudServersDestroyProtectionCreate2($id, $destroy_protection);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersDestroyProtectionCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersDetachIpv4Create2($id, $server): \PidginHost\\Sdk\Model\DetachIPv4
```
...
try {
    $result = $apiInstance->cloudServersDetachIpv4Create2($id, $server);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersDetachIpv4Create2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersDetachIpv6Create2($id, $server): \PidginHost\\Sdk\Model\DetachIPv6
```
...
try {
    $result = $apiInstance->cloudServersDetachIpv6Create2($id, $server);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersDetachIpv6Create2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersList2($page): \PidginHost\\Sdk\Model\PaginatedServerList
```
...
try {
    $result = $apiInstance->cloudServersList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersModifyPackageCreate2($id, $server_product_upgrade): \PidginHost\\Sdk\Model\ServerUpgradeResponse
```
...
try {
    $result = $apiInstance->cloudServersModifyPackageCreate2($id, $server_product_upgrade);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersModifyPackageCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersPartialUpdate2($id, $patched_server_detail): \PidginHost\\Sdk\Model\ServerDetail
```
...
try {
    $result = $apiInstance->cloudServersPartialUpdate2($id, $patched_server_detail);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersPartialUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersPowerManagementCreate2($id, $power_management_request): \PidginHost\\Sdk\Model\PowerManagement
```
...
try {
    $result = $apiInstance->cloudServersPowerManagementCreate2($id, $power_management_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersPowerManagementCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersPowerManagementRetrieve2($id): \PidginHost\\Sdk\Model\PowerManagement
```
...
try {
    $result = $apiInstance->cloudServersPowerManagementRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersPowerManagementRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersPublicInterfaceCreate2($id, $public_interface): \PidginHost\\Sdk\Model\PublicInterface
```
...
try {
    $result = $apiInstance->cloudServersPublicInterfaceCreate2($id, $public_interface);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersPublicInterfaceCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersPublicInterfaceDestroy2($id)
```
...
try {
    $apiInstance->cloudServersPublicInterfaceDestroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersPublicInterfaceDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersPublicInterfaceRetrieve2($id): \PidginHost\\Sdk\Model\PublicInterface
```
...
try {
    $result = $apiInstance->cloudServersPublicInterfaceRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersPublicInterfaceRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersRetrieve2($id): \PidginHost\\Sdk\Model\ServerDetail
```
...
try {
    $result = $apiInstance->cloudServersRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersRetryProvisionCreate2($id, $server): \PidginHost\\Sdk\Model\RetryProvision
```
...
try {
    $result = $apiInstance->cloudServersRetryProvisionCreate2($id, $server);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersRetryProvisionCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersSnapshotsCreate2($id, $snapshot_create, $page): \PidginHost\\Sdk\Model\PaginatedSnapshotList
```
...
try {
    $result = $apiInstance->cloudServersSnapshotsCreate2($id, $snapshot_create, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersSnapshotsCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersSnapshotsDestroy2($id, $snapshot_name): \PidginHost\\Sdk\Model\SnapshotDeleteQueued
```
...
try {
    $result = $apiInstance->cloudServersSnapshotsDestroy2($id, $snapshot_name);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersSnapshotsDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersSnapshotsList2($id, $page): \PidginHost\\Sdk\Model\PaginatedSnapshotList
```
...
try {
    $result = $apiInstance->cloudServersSnapshotsList2($id, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersSnapshotsList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersSnapshotsRollbackCreate2($id, $snapshot_name, $server): \PidginHost\\Sdk\Model\SnapshotRollbackQueued
```
...
try {
    $result = $apiInstance->cloudServersSnapshotsRollbackCreate2($id, $snapshot_name, $server);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersSnapshotsRollbackCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersUpdate2($id, $server_detail): \PidginHost\\Sdk\Model\ServerDetail
```
...
try {
    $result = $apiInstance->cloudServersUpdate2($id, $server_detail);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersUsageRetrieve2($id): \PidginHost\\Sdk\Model\ServerUsageResponse
```
...
try {
    $result = $apiInstance->cloudServersUsageRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersUsageRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersVolumesCreate2($server_id, $volume): \PidginHost\\Sdk\Model\Volume
```
...
try {
    $result = $apiInstance->cloudServersVolumesCreate2($server_id, $volume);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersVolumesCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersVolumesDestroy2($server_id, $volume_id)
```
...
try {
    $apiInstance->cloudServersVolumesDestroy2($server_id, $volume_id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersVolumesDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersVolumesList2($server_id): \PidginHost\\Sdk\Model\Volume[]
```
...
try {
    $result = $apiInstance->cloudServersVolumesList2($server_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersVolumesList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersVolumesPartialUpdate2($server_id, $volume_id, $patched_volume): \PidginHost\\Sdk\Model\Volume
```
...
try {
    $result = $apiInstance->cloudServersVolumesPartialUpdate2($server_id, $volume_id, $patched_volume);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersVolumesPartialUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersVolumesRetrieve2($server_id, $volume_id): \PidginHost\\Sdk\Model\Volume
```
...
try {
    $result = $apiInstance->cloudServersVolumesRetrieve2($server_id, $volume_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersVolumesRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudServersVolumesUpdate2($server_id, $volume_id, $volume): \PidginHost\\Sdk\Model\Volume
```
...
try {
    $result = $apiInstance->cloudServersVolumesUpdate2($server_id, $volume_id, $volume);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudServersVolumesUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudStorageProductsList2($page): \PidginHost\\Sdk\Model\PaginatedStorageProductList
```
...
try {
    $result = $apiInstance->cloudStorageProductsList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudStorageProductsList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudStorageProductsRetrieve2($id): \PidginHost\\Sdk\Model\StorageProduct
```
...
try {
    $result = $apiInstance->cloudStorageProductsRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudStorageProductsRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudVolumesAttachCreate2($id, $attach_volume): \PidginHost\\Sdk\Model\AttachVolume
```
...
try {
    $result = $apiInstance->cloudVolumesAttachCreate2($id, $attach_volume);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudVolumesAttachCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->cloudVolumesDestroy2($id);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudVolumesDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudVolumesDetachCreate2($id, $volume): \PidginHost\\Sdk\Model\DetachVolume
```
...
try {
    $result = $apiInstance->cloudVolumesDetachCreate2($id, $volume);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudVolumesDetachCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudVolumesList2(): \PidginHost\\Sdk\Model\Volume[]
```
...
try {
    $result = $apiInstance->cloudVolumesList2();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudVolumesList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudVolumesPartialUpdate2($id, $patched_volume): \PidginHost\\Sdk\Model\Volume
```
...
try {
    $result = $apiInstance->cloudVolumesPartialUpdate2($id, $patched_volume);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudVolumesPartialUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudVolumesRetrieve2($id): \PidginHost\\Sdk\Model\Volume
```
...
try {
    $result = $apiInstance->cloudVolumesRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudVolumesRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
cloudVolumesUpdate2($id, $volume): \PidginHost\\Sdk\Model\Volume
```
...
try {
    $result = $apiInstance->cloudVolumesUpdate2($id, $volume);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CloudApi->cloudVolumesUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
