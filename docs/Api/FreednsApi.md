...
```php
freednsDnsActivateCreate2($activate_free_dns): \PidginHost\\Sdk\Model\ActivateFreeDNSResponse
```
...
try {
    $result = $apiInstance->freednsDnsActivateCreate2($activate_free_dns);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FreednsApi->freednsDnsActivateCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
freednsDnsAddRecordCreate2($domain, $source, $dns_record_create): \PidginHost\\Sdk\Model\DNSRecordMutateResponse
```
...
try {
    $result = $apiInstance->freednsDnsAddRecordCreate2($domain, $source, $dns_record_create);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FreednsApi->freednsDnsAddRecordCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
freednsDnsDeactivateCreate2($deactivate_free_dns): \PidginHost\\Sdk\Model\DeactivateFreeDNSResponse
```
...
try {
    $result = $apiInstance->freednsDnsDeactivateCreate2($deactivate_free_dns);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FreednsApi->freednsDnsDeactivateCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
freednsDnsDeleteRecordCreate2($domain, $source, $delete_record): \PidginHost\\Sdk\Model\DeleteRecordResponse
```
...
try {
    $result = $apiInstance->freednsDnsDeleteRecordCreate2($domain, $source, $delete_record);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FreednsApi->freednsDnsDeleteRecordCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
freednsDnsList2(): \PidginHost\\Sdk\Model\FreeDNSDomain[]
```
...
try {
    $result = $apiInstance->freednsDnsList2();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FreednsApi->freednsDnsList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
freednsDnsRecordsList2($domain, $source): \PidginHost\\Sdk\Model\DNSRecord[]
```
...
try {
    $result = $apiInstance->freednsDnsRecordsList2($domain, $source);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FreednsApi->freednsDnsRecordsList2: ', $e->getMessage(), PHP_EOL;
}
```
