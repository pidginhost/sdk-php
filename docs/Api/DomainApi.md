...
```php
domainDomainCancelCreate($domain): \PidginHost\\Sdk\Model\DomainCancelResponse
```
...
try {
    $result = $apiInstance->domainDomainCancelCreate($domain);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainApi->domainDomainCancelCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\PidginHost\\Sdk\Model\DomainCancelResponse**](../Model/DomainCancelResponse.md)
...
```php
domainDomainCancelCreate2($domain): \PidginHost\\Sdk\Model\DomainCancelResponse
```
...
try {
    $result = $apiInstance->domainDomainCancelCreate2($domain);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainApi->domainDomainCancelCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\PidginHost\\Sdk\Model\ContactsUpdateResponse**](../Model/ContactsUpdateResponse.md)
...
```php
domainDomainContactsCreate2($domain, $contacts_update): \PidginHost\\Sdk\Model\ContactsUpdateResponse
```
...
try {
    $result = $apiInstance->domainDomainContactsCreate2($domain, $contacts_update);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainApi->domainDomainContactsCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\PidginHost\\Sdk\Model\NameserversUpdateResponse**](../Model/NameserversUpdateResponse.md)
...
```php
domainDomainNameserversCreate2($domain, $nameservers_update): \PidginHost\\Sdk\Model\NameserversUpdateResponse
```
...
try {
    $result = $apiInstance->domainDomainNameserversCreate2($domain, $nameservers_update);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DomainApi->domainDomainNameserversCreate2: ', $e->getMessage(), PHP_EOL;
}
```
