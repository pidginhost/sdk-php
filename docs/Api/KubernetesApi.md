...
```php
kubernetesClustersEligibleVmsRetrieve2($id): \PidginHost\\Sdk\Model\EligibleVMsResponse
```
...
try {
    $result = $apiInstance->kubernetesClustersEligibleVmsRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersEligibleVmsRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersLbFirewallCreate2($cluster_id, $lb_firewall_rule): \PidginHost\\Sdk\Model\LBFirewallRule
```
...
try {
    $result = $apiInstance->kubernetesClustersLbFirewallCreate2($cluster_id, $lb_firewall_rule);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersLbFirewallCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersLbFirewallDestroy2($cluster_id, $id)
```
...
try {
    $apiInstance->kubernetesClustersLbFirewallDestroy2($cluster_id, $id);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersLbFirewallDestroy2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersLbFirewallList2($cluster_id, $page): \PidginHost\\Sdk\Model\PaginatedLBFirewallRuleList
```
...
try {
    $result = $apiInstance->kubernetesClustersLbFirewallList2($cluster_id, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersLbFirewallList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersLbFirewallPartialUpdate2($cluster_id, $id, $patched_lb_firewall_rule): \PidginHost\\Sdk\Model\LBFirewallRule
```
...
try {
    $result = $apiInstance->kubernetesClustersLbFirewallPartialUpdate2($cluster_id, $id, $patched_lb_firewall_rule);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersLbFirewallPartialUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersLbFirewallRetrieve2($cluster_id, $id): \PidginHost\\Sdk\Model\LBFirewallRule
```
...
try {
    $result = $apiInstance->kubernetesClustersLbFirewallRetrieve2($cluster_id, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersLbFirewallRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersLbFirewallUpdate2($cluster_id, $id, $lb_firewall_rule): \PidginHost\\Sdk\Model\LBFirewallRule
```
...
try {
    $result = $apiInstance->kubernetesClustersLbFirewallUpdate2($cluster_id, $id, $lb_firewall_rule);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersLbFirewallUpdate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersResourcePoolsNodesMetricsRetrieve2($cluster_id, $id, $pool_id): \PidginHost\\Sdk\Model\NodeMetricsResponse
```
...
try {
    $result = $apiInstance->kubernetesClustersResourcePoolsNodesMetricsRetrieve2($cluster_id, $id, $pool_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersResourcePoolsNodesMetricsRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersResourcePoolsNodesRrdRetrieve2($cluster_id, $id, $pool_id): \PidginHost\\Sdk\Model\NodeRRDResponse
```
...
try {
    $result = $apiInstance->kubernetesClustersResourcePoolsNodesRrdRetrieve2($cluster_id, $id, $pool_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersResourcePoolsNodesRrdRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersToggleCloudVmAccessCreate2($id): \PidginHost\\Sdk\Model\ToggleCloudVMAccessResponse
```
...
try {
    $result = $apiInstance->kubernetesClustersToggleCloudVmAccessCreate2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersToggleCloudVmAccessCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
kubernetesClustersUpgradeFeatureCreate2($id, $feature_upgrade_request): \PidginHost\\Sdk\Model\FeatureUpgradeResponse
```
...
try {
    $result = $apiInstance->kubernetesClustersUpgradeFeatureCreate2($id, $feature_upgrade_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersUpgradeFeatureCreate2: ', $e->getMessage(), PHP_EOL;
}
```
