...
```php
kubernetesClustersHttproutesList($cluster_id, $page): \PidginHost\Sdk\Model\PaginatedHTTPRouteList
```
...
try {
    $result = $apiInstance->kubernetesClustersHttproutesList($cluster_id, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersHttproutesList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\PidginHost\Sdk\Model\PaginatedHTTPRouteList**](../Model/PaginatedHTTPRouteList.md)
...
```php
kubernetesClustersHttproutesRetrieve($cluster_id, $id): \PidginHost\Sdk\Model\HTTPRoute
```
...
try {
    $result = $apiInstance->kubernetesClustersHttproutesRetrieve($cluster_id, $id);
    print_r($result);
} catch (Exception $e) {
...
[**\PidginHost\Sdk\Model\K8sPortForward**](../Model/K8sPortForward.md)
...
```php
kubernetesClustersPortForwardsList($cluster_id, $page): \PidginHost\Sdk\Model\PaginatedK8sPortForwardList
```
...
try {
    $result = $apiInstance->kubernetesClustersPortForwardsList($cluster_id, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersPortForwardsList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\PidginHost\Sdk\Model\PaginatedK8sPortForwardList**](../Model/PaginatedK8sPortForwardList.md)
...
```php
kubernetesClustersPortForwardsRetrieve($cluster_id, $id): \PidginHost\Sdk\Model\K8sPortForward
```
...
try {
    $result = $apiInstance->kubernetesClustersPortForwardsRetrieve($cluster_id, $id);
    print_r($result);
} catch (Exception $e) {
...
```php
kubernetesClustersResourcePoolsNodesRrdRetrieve($cluster_id, $id, $pool_id, $timeframe): \PidginHost\Sdk\Model\NodeRRDResponse
```
...
$id = 'id_example'; // string
$pool_id = 56; // int
$timeframe = 'hour'; // string | Window of recorded data to return.

try {
    $result = $apiInstance->kubernetesClustersResourcePoolsNodesRrdRetrieve($cluster_id, $id, $pool_id, $timeframe);
    print_r($result);
} catch (Exception $e) {
...
| **id** | **string**|  | |
| **pool_id** | **int**|  | |
| **timeframe** | **string**| Window of recorded data to return. | [optional] [default to &#39;hour&#39;] |
...
```php
kubernetesClustersTcproutesList($cluster_id, $page): \PidginHost\Sdk\Model\PaginatedTCPRouteList
```
...
try {
    $result = $apiInstance->kubernetesClustersTcproutesList($cluster_id, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersTcproutesList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\PidginHost\Sdk\Model\PaginatedTCPRouteList**](../Model/PaginatedTCPRouteList.md)
...
```php
kubernetesClustersTcproutesRetrieve($cluster_id, $id): \PidginHost\Sdk\Model\TCPRoute
```
...
try {
    $result = $apiInstance->kubernetesClustersTcproutesRetrieve($cluster_id, $id);
    print_r($result);
} catch (Exception $e) {
...
```php
kubernetesClustersUdproutesList($cluster_id, $page): \PidginHost\Sdk\Model\PaginatedUDPRouteList
```
...
try {
    $result = $apiInstance->kubernetesClustersUdproutesList($cluster_id, $page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling KubernetesApi->kubernetesClustersUdproutesList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\PidginHost\Sdk\Model\PaginatedUDPRouteList**](../Model/PaginatedUDPRouteList.md)
...
```php
kubernetesClustersUdproutesRetrieve($cluster_id, $id): \PidginHost\Sdk\Model\UDPRoute
```
...
try {
    $result = $apiInstance->kubernetesClustersUdproutesRetrieve($cluster_id, $id);
    print_r($result);
} catch (Exception $e) {
