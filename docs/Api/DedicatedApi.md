...
```php
dedicatedServersList2($page): \PidginHost\\Sdk\Model\PaginatedDedicatedServerList
```
...
try {
    $result = $apiInstance->dedicatedServersList2($page);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DedicatedApi->dedicatedServersList2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
dedicatedServersPowerCreate2($id, $power_action): \PidginHost\\Sdk\Model\PowerActionResponse
```
...
try {
    $result = $apiInstance->dedicatedServersPowerCreate2($id, $power_action);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DedicatedApi->dedicatedServersPowerCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
dedicatedServersRdnsCreate2($id, $dedicated_rdns): \PidginHost\\Sdk\Model\RDNSUpdateResponse
```
...
try {
    $result = $apiInstance->dedicatedServersRdnsCreate2($id, $dedicated_rdns);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DedicatedApi->dedicatedServersRdnsCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
dedicatedServersReinstallCreate2($id, $reinstall): \PidginHost\\Sdk\Model\ReinstallResponse
```
...
try {
    $result = $apiInstance->dedicatedServersReinstallCreate2($id, $reinstall);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DedicatedApi->dedicatedServersReinstallCreate2: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
dedicatedServersRetrieve2($id): \PidginHost\\Sdk\Model\DedicatedServer
```
...
try {
    $result = $apiInstance->dedicatedServersRetrieve2($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DedicatedApi->dedicatedServersRetrieve2: ', $e->getMessage(), PHP_EOL;
}
```
