...
**price_per_month** | **float** |  | [optional]
**price_per_hour** | **string** |  | [optional] [readonly]
...
**dual_stack** | **string** |  | [optional] [readonly]
**protected** | **bool** |  | [optional]
**talos_version** | **string** |  | [optional] [readonly]
**talos_upgrade_available** | **string** |  | [optional] [readonly]
**talos_next_version** | **string** |  | [optional] [readonly]
**storage_quota_gb** | **string** |  | [optional] [readonly]
**last_pool_used_bytes** | **string** |  | [optional] [readonly]
